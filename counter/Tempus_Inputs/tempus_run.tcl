# ============================================================
# run_tempus_sta.tcl
# Cadence Tempus Timing Signoff — Pre-Layout STA Script
# Design  : counter (4-bit up/down counter)
# Library : slow.lib (90nm, worst-case SS corner)
# Inputs  : counter_netlist.v
#           counter_constraints.sdc
#           slow.lib
#
# Outputs : setup_report.rpt
#           hold_report.rpt
#           timing_summary.rpt
#           clock_report.rpt
#
# Usage:
#   tempus -f run_tempus_sta.tcl | tee tempus_run.log
# ============================================================
